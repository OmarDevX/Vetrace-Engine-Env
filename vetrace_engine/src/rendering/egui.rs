...
const DEFAULT_VERT_SRC: &str =
    include_str!("../../assets/shaders/opengl/default/default.vert");
const DEFAULT_FRAG_SRC: &str =
    include_str!("../../assets/shaders/opengl/default/default.frag");
const ADAPTIVE_VERT_SRC: &str =
    include_str!("../../assets/shaders/opengl/default/adaptive.vert");
const ADAPTIVE_FRAG_SRC: &str =
    include_str!("../../assets/shaders/opengl/default/adaptive.frag");
...
impl EguiRenderer {
    pub fn new(window: &sdl2::video::Window, scale: f32, shader_ver: ShaderVersion) -> EguiRenderer {
        unsafe {
    ...
    pub fn set_pixels_per_point(&mut self, dpi: f32) {
        self.pixels_per_point = dpi;
        let (width, height) = self.canvas_size;
        let rect = egui::vec2(width as f32, height as f32) / dpi;
    ...
    pub fn render_ui(
        ...
        let paint_jobs = ctx.tessellate(full_output.shapes, self.pixels_per_point);
