...
pub struct WgpuRenderer {
    ...
    ddgi_irradiance_atlas_texture: Option<Texture>,
    ddgi_irradiance_atlas_view: Option<TextureView>,
    ddgi_distance_moments_atlas_texture: Option<Texture>,
    ddgi_distance_moments_atlas_view: Option<TextureView>,
    ddgi_probe_state_texture: Option<Texture>,
    ddgi_probe_state_view: Option<TextureView>,
    ddgi_probe_state_buffer: Option<Buffer>,
    ddgi_probe_relocation_buffer: Option<Buffer>,
    ddgi_ray_output_texture: Option<Texture>,
    ddgi_ray_output_view: Option<TextureView>,
    ddgi_ray_distance_texture: Option<Texture>,
    ddgi_ray_distance_view: Option<TextureView>,
    ddgi_ray_output_buffer: Option<Buffer>,
    ddgi_previous_irradiance_texture: Option<Texture>,
    ddgi_previous_irradiance_view: Option<TextureView>,
    ddgi_previous_distance_moments_texture: Option<Texture>,
    ddgi_previous_distance_moments_view: Option<TextureView>,
    ddgi_trace_update_params_buffer: Option<Buffer>,
    ddgi_resolve_params_buffer: Option<Buffer>,
    ddgi_trace_update_bind_group_layout: Option<BindGroupLayout>,
    ...
    prev_ddgi_volume_desc: Option<DdgiVolumeDesc>,
    prev_ddgi_trace_update_uniforms: Option<DdgiTraceUpdateUniforms>,
    prev_ddgi_resolve_uniforms: Option<DdgiResolveUniforms>,
    ...
    gi_resolve_params_buffer: Buffer,
    ...
    gi_resolve_bind_group_layout: BindGroupLayout,
    gi_resolve_bind_group: BindGroup,
    gi_resolve_pipeline: Option<ComputePipeline>,
    ...
    primitive_shadow_bind_group: BindGroup,
    ...
    primitive_cube_instance_buffer: Buffer,
    primitive_cube_instance_capacity: usize,
    primitive_sphere_instance_buffer: Buffer,
    primitive_sphere_instance_capacity: usize,
    primitive_shadow_cube_instance_buffer: Buffer,
    primitive_shadow_cube_instance_capacity: usize,
    primitive_shadow_sphere_instance_buffer: Buffer,
    primitive_shadow_sphere_instance_capacity: usize,
    ...
    custom_material_buffer_capacity: usize,
    light_header_buffer: Buffer,
    light_index_buffer: Buffer,
    light_index_buffer_capacity: usize,
    triangle_count: u32,
    bvh_node_count: u32,
    ...
    prev_gi_resolve_params: Option<GiResolveParams>,
    ...
    prev_custom_materials: Vec<GpuCustomMaterial>,
    prev_light_indices: Vec<u32>,
    prev_texture_count: usize,
    prev_objects: Vec<GpuObject>,
    prev_materials: Vec<crate::scene::object::GpuMaterial>,
